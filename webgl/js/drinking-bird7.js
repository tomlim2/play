...
function render() {
	...
	renderer.setViewport( canvasWidth, canvasHeight, canvasWidth, canvasHeight );
	...
	renderer.setViewport( 0, canvasHeight, canvasWidth, canvasHeight );
	...
	renderer.setViewport( canvasWidth, 0, canvasWidth, canvasHeight );
